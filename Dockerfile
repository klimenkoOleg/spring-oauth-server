...
ENV MAIN_FULL_CLASS_NAME=com.oklimenko.gateway.GatewayApplication
...
COPY ./target/oauth-authorization-server.jar ${APP_HOME}
...
ENTRYPOINT ["sh","-c","exec java -jar oauth-authorization-server.jar ${0} ${@}"]
